...
-- now add the undocumented fonts to the fonts table
if Turbine.UI.Lotro.Font.TimesRoman12==nil then
	Turbine.UI.Lotro.Font.TimesRoman12=0x42000021
end
if Turbine.UI.Lotro.Font.TimesRoman20==nil then
	Turbine.UI.Lotro.Font.TimesRoman20=0x4200000e
end

if Turbine.UI.Lotro.Font.TimesRoman22==nil then
	Turbine.UI.Lotro.Font.TimesRoman22=0x4200000f
end
if Turbine.UI.Lotro.Font.TimesRoman24==nil then
	Turbine.UI.Lotro.Font.TimesRoman24=0x42000010
end
-- There's something odd about the Calibri font, it might have been removed
--if Turbine.UI.Lotro.Font.Calibri14==nil then
--	Turbine.UI.Lotro.Font.Calibri14=0x4200002b
--end
...
FontSelectList:SetSize(344,204)
...
FontSelectList.ListData:SetSize(FontSelectList:GetWidth()-14,FontSelectList:GetHeight()-4)
FontSelectList.ListData:SetPosition(2,2)
FontSelectList.ListData:SetBackColor(Turbine.UI.Color(.1,.1,.1))
...
FontSelectList.ListVScroll:SetPosition(FontSelectList:GetWidth()-12,2);
FontSelectList.ListVScroll:SetWidth(10);
FontSelectList.ListVScroll:SetHeight(FontSelectList.ListData:GetHeight());
...
FontSelectList.SizeChanged=function(sender,args)
	...
	FontSelectList.ListData:SetSize(width-14,height-4)
	FontSelectList.ListVScroll:SetLeft(width-12)
	FontSelectList.ListVScroll:SetHeight(height-4)
